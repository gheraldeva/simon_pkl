        ...
        <div class="flex">
            ...
            <div class="flex flex-col mt-52 mb-10 w-[100%] mx-20 ml-80 bg-white shadow-md p-24 relative">
                <div class="flex flex-row gap-10 ">
                    ...
                    <p class="w-[70%] text-lg font-bold">{{ dudies.nama_instansi_perusahaan }}</p>
                </div>
                ...
                <div class="flex flex-row gap-10 w-[100%]">
                    <p class="w-[30%] text-right font-medium text-lg text-nowrap">Bidang : </p>
                    <p class="w-[70%] text-lg font-bold">{{ dudies.bidang }}</p>
                </div>
                <div class="flex flex-row gap-10 w-[100%]">
                    <p class="w-[30%] text-right font-medium text-lg text-nowrap">Deskripsi Perusahaan : </p>
                    <p class="w-[70%] text-lg font-bold">{{ dudies.deskripsi }}</p>
                </div>
